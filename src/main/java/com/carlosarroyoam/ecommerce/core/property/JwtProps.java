...
/**
 * Propiedades de configuración de JWT bajo el prefijo {@code application.jwt}: tiempos de vida
 * del access token y del refresh token, y el tiempo de vida máximo absoluto de un refresh token.
 */
@Component
