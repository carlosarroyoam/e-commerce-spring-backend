 ...
 * (decodificador, validador de emisor/firma, {@code AuthPrincipalMapper}) en tests sin mockear nada
 * de seguridad.
 *
...
public class JwtTestTokenFactory {
   ...
   */
  public String staffToken(long id, String email, List<String> roles) {
    return token(id, email, PrincipalType.STAFF.toString(), DEFAULT_TTL, roles);
  }
   ...
   * @return el JWT firmado como cadena compacta
   */
  public String customerToken(long id, String email, List<String> roles) {
    return token(id, email, PrincipalType.CUSTOMER.toString(), DEFAULT_TTL, roles);
  }
   ...
   */
  public String expiredToken(long id, String email, String principalType, List<String> roles) {
    return token(id, email, principalType, Duration.ofSeconds(-10), roles);
  }

  private String token(
      long id, String email, String principalType, Duration ttl, List<String> roles) {
